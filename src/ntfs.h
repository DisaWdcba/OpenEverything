...
int ntfs_read_mft(HANDLE hVolume, INDEX_BUILD *build, int volume_index, HWND hwnd_progress);
int ntfs_read_usn_index(HANDLE hVolume, INDEX_BUILD *build, int volume_index, HWND hwnd_progress);
